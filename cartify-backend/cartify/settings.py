...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'd5bdCdeCCG554agFEe4G4A4ca6G5fC23',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Cartify API',
    'DESCRIPTION': 'Cartify API is a fully functional, robust and secure Ecommerce RESTful API built for the Cartify mobile and web app.',
    'VERSION': '1.0.0',
